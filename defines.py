...
CLEANEDTRAIN_559_PATH = os.path.join(CLEANED_DATA_DIR2, '559-ws-trainingCleaned.xml')
CLEANEDTRAIN_563_PATH = os.path.join(CLEANED_DATA_DIR2, '563-ws-trainingCleaned.xml')
CLEANEDTRAIN_570_PATH = os.path.join(CLEANED_DATA_DIR2, '570-ws-trainingCleaned.xml')
CLEANEDTRAIN_575_PATH = os.path.join(CLEANED_DATA_DIR2, '575-ws-trainingCleaned.xml')
CLEANEDTRAIN_588_PATH = os.path.join(CLEANED_DATA_DIR2, '588-ws-trainingCleaned.xml')
CLEANEDTRAIN_591_PATH = os.path.join(CLEANED_DATA_DIR2, '591-ws-trainingCleaned.xml')

CLEANEDTRAIN2_540_PATH = os.path.join(CLEANED_DATA_DIR2, '540-ws-trainingCleaned.xml')
CLEANEDTRAIN2_544_PATH = os.path.join(CLEANED_DATA_DIR2, '544-ws-trainingCleaned.xml')
CLEANEDTRAIN2_552_PATH = os.path.join(CLEANED_DATA_DIR2, '552-ws-trainingCleaned.xml')
#CLEANEDTRAIN2_567_PATH = os.path.join(CLEANED_DATA_DIR2, '567-ws-trainingCleaned.xml')
CLEANEDTRAIN2_596_PATH = os.path.join(CLEANED_DATA_DIR2, '596-ws-trainingCleaned.xml')



CLEANEDTEST_559_PATH = os.path.join(CLEANED_DATA_DIR2, '559-ws-testingCleaned.xml')
CLEANEDTEST_563_PATH = os.path.join(CLEANED_DATA_DIR2, '563-ws-testingCleaned.xml')
CLEANEDTEST_570_PATH = os.path.join(CLEANED_DATA_DIR2, '570-ws-testingCleaned.xml')
CLEANEDTEST_575_PATH = os.path.join(CLEANED_DATA_DIR2, '575-ws-testingCleaned.xml')
CLEANEDTEST_588_PATH = os.path.join(CLEANED_DATA_DIR2, '588-ws-testingCleaned.xml')
CLEANEDTEST_591_PATH = os.path.join(CLEANED_DATA_DIR2, '591-ws-testingCleaned.xml')

CLEANEDTEST2_540_PATH = os.path.join(CLEANED_DATA_DIR2, '540-ws-testingCleaned.xml')
CLEANEDTEST2_544_PATH = os.path.join(CLEANED_DATA_DIR2, '544-ws-testingCleaned.xml')
CLEANEDTEST2_552_PATH = os.path.join(CLEANED_DATA_DIR2, '552-ws-testingCleaned.xml')
#CLEANEDTEST2_567_PATH = os.path.join(CLEANED_DATA_DIR2, '567-ws-testingCleaned.xml')
CLEANEDTEST2_584_PATH = os.path.join(CLEANED_DATA_DIR2, '584-ws-testingCleaned.xml')
CLEANEDTEST2_596_PATH = os.path.join(CLEANED_DATA_DIR2, '596-ws-testingCleaned.xml')
...
CLEANEDTEST2_FILE_PATHS = [CLEANEDTEST2_540_PATH, CLEANEDTEST2_544_PATH, CLEANEDTEST2_552_PATH,
...
data_train1 = [CLEANEDTRAIN_559_PATH, CLEANEDTRAIN_563_PATH, CLEANEDTRAIN2_540_PATH, CLEANEDTRAIN2_544_PATH]
data_test1 = [CLEANEDTEST_559_PATH, CLEANEDTEST_563_PATH, CLEANEDTEST2_540_PATH, CLEANEDTEST2_544_PATH]

data_train2 = [CLEANEDTRAIN_575_PATH, CLEANEDTRAIN_591_PATH, CLEANEDTRAIN2_552_PATH, CLEANEDTRAIN2_596_PATH]
data_test2 = [CLEANEDTEST_570_PATH, CLEANEDTEST2_596_PATH, CLEANEDTEST_563_PATH, CLEANEDTEST_575_PATH]
