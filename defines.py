...
CLEANEDTRAIN_559_PATH = os.path.join(TRAIN_DIR, '559-ws-trainingCleanedxml')
CLEANEDTRAIN_563_PATH = os.path.join(TRAIN_DIR, '563-ws-trainingCleaned.xml')
CLEANEDTRAIN_570_PATH = os.path.join(TRAIN_DIR, '570-ws-trainingCleaned.xml')
CLEANEDTRAIN_575_PATH = os.path.join(TRAIN_DIR, '575-ws-trainingCleaned.xml')
CLEANEDTRAIN_588_PATH = os.path.join(TRAIN_DIR, '588-ws-trainingCleaned.xml')
CLEANEDTRAIN_591_PATH = os.path.join(TRAIN_DIR, '591-ws-trainingCleaned.xml')

CLEANEDTRAIN2_540_PATH = os.path.join(TRAIN2_DIR, '540-ws-trainingCleaned.xml')
CLEANEDTRAIN2_544_PATH = os.path.join(TRAIN2_DIR, '544-ws-trainingCleaned.xml')
CLEANEDTRAIN2_552_PATH = os.path.join(TRAIN2_DIR, '552-ws-trainingCleaned.xml')
CLEANEDTRAIN2_567_PATH = os.path.join(TRAIN2_DIR, '567-ws-trainingCleaned.xml')
CLEANEDTRAIN2_596_PATH = os.path.join(TRAIN2_DIR, '596-ws-trainingCleaned.xml')
...
CLEANEDTRAIN_FILE_PATHS = [CLEANEDTRAIN_559_PATH, CLEANEDTRAIN_563_PATH, CLEANEDTRAIN_570_PATH, CLEANEDTRAIN_575_PATH, CLEANEDTRAIN_588_PATH, CLEANEDTRAIN_591_PATH]
CLEANEDTRAIN2_FILE_PATHS = [CLEANEDTRAIN2_540_PATH, CLEANEDTRAIN2_544_PATH, CLEANEDTRAIN2_552_PATH, CLEANEDTRAIN2_567_PATH, CLEANEDTRAIN2_596_PATH]
...
TEST_559_PATH = os.path.join(TEST_DIR, '559-ws-testingCleaned.xml')
TEST_563_PATH = os.path.join(TEST_DIR, '563-ws-testingCleaned.xml')
TEST_570_PATH = os.path.join(TEST_DIR, '570-ws-testingCleaned.xml')
TEST_575_PATH = os.path.join(TEST_DIR, '575-ws-testingCleaned.xml')
TEST_588_PATH = os.path.join(TEST_DIR, '588-ws-testingCleaned.xml')
TEST_591_PATH = os.path.join(TEST_DIR, '591-ws-testingCleaned.xml')

TEST2_540_PATH = os.path.join(TEST2_DIR, '540-ws-testingCleaned.xml')
TEST2_544_PATH = os.path.join(TEST2_DIR, '544-ws-testingCleaned.xml')
TEST2_552_PATH = os.path.join(TEST2_DIR, '552-ws-testingCleaned.xml')
TEST2_567_PATH = os.path.join(TEST2_DIR, '567-ws-testingCleaned.xml')
TEST2_584_PATH = os.path.join(TEST2_DIR, '584-ws-testingCleaned.xml')
TEST2_596_PATH = os.path.join(TEST2_DIR, '596-ws-testingCleaned.xml')

CLEANEDTEST_559_PATH = os.path.join(TEST_DIR, '559-ws-testingCleaned.xml')
CLEANEDTEST_563_PATH = os.path.join(TEST_DIR, '563-ws-testingCleaned.xml')
CLEANEDTEST_570_PATH = os.path.join(TEST_DIR, '570-ws-testingCleaned.xml')
CLEANEDTEST_575_PATH = os.path.join(TEST_DIR, '575-ws-testingCleaned.xml')
CLEANEDTEST_588_PATH = os.path.join(TEST_DIR, '588-ws-testingCleaned.xml')
CLEANEDTEST_591_PATH = os.path.join(TEST_DIR, '591-ws-testingCleaned.xml')

CLEANEDTEST2_540_PATH = os.path.join(TEST2_DIR, '540-ws-testingCleaned.xml')
CLEANEDTEST2_544_PATH = os.path.join(TEST2_DIR, '544-ws-testingCleaned.xml')
CLEANEDTEST2_552_PATH = os.path.join(TEST2_DIR, '552-ws-testingCleaned.xml')
CLEANEDTEST2_567_PATH = os.path.join(TEST2_DIR, '567-ws-testingCleaned.xml')
CLEANEDTEST2_584_PATH = os.path.join(TEST2_DIR, '584-ws-testingCleaned.xml')
CLEANEDTEST2_596_PATH = os.path.join(TEST2_DIR, '596-ws-testingCleaned.xml')
...
CLEANEDTEST_FILE_PATHS = [CLEANEDTEST_559_PATH, CLEANEDTEST_563_PATH, CLEANEDTEST_570_PATH, CLEANEDTEST_575_PATH, CLEANEDTEST_588_PATH, CLEANEDTEST_591_PATH]
CLEANEDTEST2_FILE_PATHS = [CLEANEDTEST2_540_PATH, CLEANEDTEST2_544_PATH, CLEANEDTEST2_552_PATH, CLEANEDTEST2_567_PATH, CLEANEDTEST2_584_PATH, CLEANEDTEST2_596_PATH]
