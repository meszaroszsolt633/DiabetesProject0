...
from functions import loadeverycleanedxml, loadeveryxml, data_cleaner, dataPrepareRegression
...
x_train, y_train, x_test, y_test = dataPrepareRegression(train, test, 3, 15,False,6,1.0,False)
