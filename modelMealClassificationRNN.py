...
def create_dataset_mealdetection(dataset, look_back=1):
    dataX, dataY = [], []
...
def model_mealdetection_RNN(dataTrain, dataValidation, lookback=50, maxfiltersize=10, epochnumber=50, modelnumber=1, learning_rate=0.001, oversampling=False):
    ...
    trainX,trainY = create_dataset_mealdetection(featurestrain, lookback)
    validX,validY = create_dataset_mealdetection(featuresvalidation, lookback)
